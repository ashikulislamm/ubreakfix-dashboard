...
import { Calendar, CheckCircle, Clock, Copy, Check } from "lucide-react";
...
export const AppointmentsPage: React.FC = () => {
  ...
  return (
    <>
      {/* Toast Notification */}
      {showToast && (
        <div className="fixed top-4 right-4 z-[9999] bg-green-500 text-white px-4 py-3 rounded-lg shadow-2xl flex items-center gap-2 transition-all duration-300 ease-in-out">
      ...
      <div className="p-4 lg:p-8 space-y-4 lg:space-y-6">
        ...
        <Card className="bg-[#0F1F3A] border-gray-800 p-4 lg:p-6">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white px-4 lg:px-6 py-2 lg:py-3 rounded-lg flex items-center justify-center gap-2 transition-colors whitespace-nowrap"
            >
        ...
        <Card className="bg-[#0F1F3A] border-gray-800 overflow-hidden">
            ...
            <table className="w-full min-w-[800px]">
              ...
              <tbody>
                {appointments.map((appointment, index) => (
                  <tr
                    key={index}
                    className="border-b border-gray-800 hover:bg-[#1A2942] transition-colors"
                  >
                    <td className="p-4">
          ...
          <div className="p-3 lg:p-4 flex items-center justify-center gap-1 lg:gap-2 flex-wrap">
            ...
            <button className="px-2 lg:px-3 py-1 lg:py-2 text-sm lg:text-base bg-blue-500 text-white rounded">
              1
            </button>
            <button className="px-2 lg:px-3 py-1 lg:py-2 text-sm lg:text-base text-gray-400 hover:text-white transition-colors">
              2
            </button>
            <button className="hidden sm:block px-2 lg:px-3 py-1 lg:py-2 text-sm lg:text-base text-gray-400 hover:text-white transition-colors">
              3
            </button>
            <button className="hidden sm:block px-2 lg:px-3 py-1 lg:py-2 text-sm lg:text-base text-gray-400 hover:text-white transition-colors">
              4
            </button>
            <button className="hidden md:block px-2 lg:px-3 py-1 lg:py-2 text-sm lg:text-base text-gray-400 hover:text-white transition-colors">
              5
            </button>
            <span className="hidden md:block px-2 lg:px-3 py-1 lg:py-2 text-sm lg:text-base text-gray-400">
              ...
            </span>
            <button className="hidden sm:block px-2 lg:px-3 py-1 lg:py-2 text-sm lg:text-base text-gray-400 hover:text-white transition-colors">
              11
